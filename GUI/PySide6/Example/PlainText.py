...
from PySide6.QtCore import (QFile, QFileInfo, QPoint, QSettings, QSize, Qt, QTextStream, QByteArray, 
                                                    QDir, QIODevice, QResource, QEvent)
from PySide6.QtGui import QIcon, QKeySequence, QTextCursor, QTextCharFormat, QPalette
...
class MainWindow(QMainWindow):
    ...
    def about(self):
        ...
        message =  ("<span style='text-shadow: #2e3436 2px 2px 2px; color: #6169e1; font-size: 24pt;font-weight: bold;'><strong>QTextEdit 1.2</strong></span></p><br><br>created by<h2 >" + link + "</h2> with PySide6" 
